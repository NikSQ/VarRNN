...
nn_config.add_layer_config(n_neurons=20, layer_config=lstm_layer_config, var_scope="lstm_1")
#nn_config.add_layer_config(n_neurons=20, layer_config=lstm_layer_config, var_scope="lstm_2")
...
train_config = TrainConfig(task_id=task_id)\
    ...
    .set_algorithm(algorithm=AlgorithmC.ARM, n_forward_passes=1500, ste_type=AlgorithmC.NO_STE)\
...
info_config.add_model_saver(filename="test", task_id=task_id)
