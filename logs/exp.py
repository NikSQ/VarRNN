...
pretrain_config['path'] = 'pretrain_red_mnist'
...
info_config = {'calc_performance_every': 1,
               'n_samples': 5,
               'tensorboard': {'enabled': True, 'path': '../tb/' + filename + '_' + str(task_id), 'period': 200,
                               'weights': True, 'gradients': False, 'results': True, 'acts': True, 'single_acts': 0},
