...
algorithm = [AlgorithmC.REPARAMETRIZATION, AlgorithmC.ARM, AlgorithmC.AR, AlgorithmC.LOG_DERIVATIVE][task_id % 4]
n_grads = [1000, 10000, 100000, 5000000][int(task_id / 4)]

train_config = TrainConfig(task_id=task_id)\
    .set_learning_rate(learning_rate=.2)\
    .set_algorithm(algorithm=algorithm, n_forward_passes=1, ste_type=AlgorithmC.NO_STE)\
