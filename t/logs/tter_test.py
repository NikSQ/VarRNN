...
pretrain_config['path'] = 'pretrain_timit_70_70_0'
...
info_config = {'calc_performance_every': 1,
               'n_samples': 100,
               'tensorboard': {'enabled': True, 'path': '../t/tb/' + filename + '_' + str(task_id), 'period': 200,
